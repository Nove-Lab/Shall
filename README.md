...
Design and invariants live in [`docs/Project_Structure_and_Architecture.md`](./docs/Project_Structure_and_Architecture.md); the `shall` CLI and the `/shall.…` agent commands each have a page of their own in [`docs/Shall_CLI_Commands.md`](./docs/Shall_CLI_Commands.md) and [`docs/Shall_Agent_Commands.md`](./docs/Shall_Agent_Commands.md); the agent plugin is documented in [`agents/claude/README.md`](./agents/claude/README.md).
