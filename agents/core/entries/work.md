...
summary: Run one turn of the work cycle, from the board to the journal.
tools: spec-and-git
---
...
{{load-skills shall-authoring shall-work}} The first is how a node file is written, named and anchored; the second is the process you are about to run.

{{load-skills-fallback shall-authoring shall-work}}
