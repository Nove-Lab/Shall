...
summary: Ask what Shall is, or what to do next in this project.
tools: readonly
---
...
{{no-write-guard}}, which is the mechanical half of the promise the guide makes in prose: a guide that wrote anything would be a turn of work nobody agreed to.
...
{{load-skills shall-help}} One skill and not two: the authoring skill is how a node file is written, and this command writes none.

{{load-skills-fallback shall-help}}
