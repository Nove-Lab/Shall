...
summary: Bring a question about the project, and land what it settles.
tools: spec-and-git
---
...
{{load-skills shall-authoring shall-raise}} The first is how a node file is written, named and anchored — needed only at the end, and loaded first so the end is not where you go looking for it; the second is the process you are about to run.

{{load-skills-fallback shall-authoring shall-raise}}
