...
summary: Write up work already done as one journal with a log per item.
tools: spec-and-git
---
...
{{load-skills shall-authoring shall-work}} The first is how a node file is written, named and anchored; the second carries the record's own shape.
